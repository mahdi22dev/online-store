...
export type AuthorLinkingCollectionsNextBlogCollectionArgs = {
  ...
  locale?: InputMaybe<Scalars["String"]["input"]>;
  order?: InputMaybe<
    Array<InputMaybe<AuthorLinkingCollectionsNextBlogCollectionOrder>>
  >;
  preview?: InputMaybe<Scalars["Boolean"]["input"]>;
  skip?: InputMaybe<Scalars["Int"]["input"]>;
};
...
export type PhoneCasesProductFilter = {
  ...
  color_contains_all?: InputMaybe<
    Array<InputMaybe<Scalars["String"]["input"]>>
  >;
  color_contains_none?: InputMaybe<
    Array<InputMaybe<Scalars["String"]["input"]>>
  >;
  color_contains_some?: InputMaybe<
    Array<InputMaybe<Scalars["String"]["input"]>>
  >;
...
export type GetContentfulProductsQueryVariables = Exact<{
  [key: string]: never;
}>;
...
export type GetContentSingleProductQuery = {
  __typename?: "Query";
  phoneCasesProduct?: {
    __typename?: "PhoneCasesProduct";
    name?: string | null;
...
export type GetContentHomeBannersQueryVariables = Exact<{
  [key: string]: never;
}>;

export type GetContentHomeBannersQuery = {
  __typename?: "Query";
...
export const GetContentfulProductsDocument = {
  kind: "Document",
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "phoneCasesProductCollection" },
            arguments: [
              {
                kind: "Argument",
  ...
  GetContentfulProductsQuery,
  GetContentfulProductsQueryVariables
>;
export const GetContentSingleProductDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "phoneCasesProduct" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "id" },
  ...
  GetContentSingleProductQueryVariables
>;
export const GetContentHomeBannersDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetContentHomeBanners" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "phonearmomorBannerCollection" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "destantion" },
                      },
                      {
                        kind: "Field",
  ...
  GetContentHomeBannersQuery,
  GetContentHomeBannersQueryVariables
>;
